...
function ExcitationDropHeader() {
  ...
  return (
    <div className={StyleSheet.dropList_Header}>
      <div className={[StyleSheet.dropList_HeaderCheckBox, StyleSheet.flexEnd].join(' ')}>{/* <Checkbox onChange={onAllChange} /> */}</div>
...
const MemoExcitationHeader = React.memo(ExcitationDropHeader)

export default MemoExcitationHeader
