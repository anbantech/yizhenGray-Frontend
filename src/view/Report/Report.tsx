...
// import { exportReport } from 'Src/Api/server'
...
//               <CancelButton name='下载报告' width='88px' height='36px' onClick={exportReportZip} />
//             </div>
//             <iframe id='reportData' src='/onLineReport/index.html' width='100%' height='100%' allowFullScreen frameBorder='0' title='报告' />
//           </div>
//         )
//       ) : (
//         <ReportLoading />
