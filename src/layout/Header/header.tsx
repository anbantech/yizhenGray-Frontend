...
function Header(props: any) {
  ...
  const name: any = {
    '/projects': '项目列表',
    '/projects/TaskList': '任务列表',
    '/projects/TaskList/Flow': '任务',
    '/projects/TaskList/ReExamle': '实例列表',
    '/projects/TaskList/ReExamle/Detail': '实例详情',
    '/projects/TaskList/ReExamle/Detail/UseCase': '用例生成详情',
    '/projects/TaskList/ReExamle/Detail/Log': '日志详情',
    '/projects/TaskList/ReExamle/Detail/Scale': '仿真数据',
    '/Exception': '异常处理器',
    '/targets': '目标列表',
    '/Arrgemnt': '协议列表',
    '/Arrgemnt/NewArrgement': '新建协议',
    '/Arrgemnt/NewArrgement/baseTemplate': '模板',
    '/Arrgemnt/NewArrgement/responseTemplate': '响应模板',
    '/errorHandlers': '基本信息',
    '/Arrgemnt/StepSecond': '协议交互',
    '/Arrgemnt/ChangeArrgement': '修改协议',
    '/Arrgemnt/StepSecond/baseTemplate': '模板',
    '/Arrgemnt/StepSecond/responseTemplate': '响应模板',
    '/Exception/create': '创建异常处理器',
    '/Exception/createCopy': '修改异常处理器',
    '/targets/create': '创建目标列表',
    '/targets/createCopy': '修改目标列表',
    '/message': '信息中心',
    '/byPass': '旁路列表',
    '/UserLog': '操作日志',
    '/UserList': '用户列表',
    '/byPass/newCreateByPass': '新建旁路',
    '/byPass/compileCreateByPass': '修改旁路信息',
    '/backupData': '备份设置',
    '/OnlineReport': '报告预览'
  }
